        ...
        <div id="stil" class="stil">
            ...
            <table border="1" class=" table table-striped" id="tblData">
                ...
                <tr>
                    ...
                    <th class="xlText" style="background-color: darkgreen; color: white; height: 100px;">Хисоб рақам
                    </th>
                ...
                <? foreach ($document as $key => $doc) { ?>
                    <tr>
                        ...
                        <!--            <a href="-->
                        <? //=Url::to(['maxsulot/update','id'=>$value->id]);?><!--"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>-->
